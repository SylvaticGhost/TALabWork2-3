...
public class DataProvider
{
    ...
    public DataProvider()
    {
        ...
        [
            ...
            new Edge(GetVertix('C'), GetVertix('E')),
            new Edge(GetVertix('D'), GetVertix('F')),
            new Edge(GetVertix('F'), GetVertix('E')),
            new Edge(GetVertix('D'), GetVertix('G')),
            new Edge(GetVertix('D'), GetVertix('I')),
            new Edge(GetVertix('J'), GetVertix('D')),
            new Edge(GetVertix('G'), GetVertix('H')),
            new Edge(GetVertix('G'), GetVertix('I')),
            new Edge(GetVertix('G'), GetVertix('J')),
            new Edge(GetVertix('H'), GetVertix('I')),
